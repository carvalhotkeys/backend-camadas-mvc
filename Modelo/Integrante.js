import IntegranteBD from "../Persistencia/IntegranteBD.js";
...
export default class Integrante{
    ...
    constructor(cpf, nome, endereco, bairro, cidade, uf, telefone, email, instrumento){   
        this.#cpf = cpf;
        this.#nome = nome;
    ...
    set instrumento(novaoInstrumento){
        this.#instrumento = novaoInstrumento;
    }
    ...
    async gravar(){
        ...
        await integranteBD.incluir(this);

    }

    async atualizar(){
        const integranteBD = new IntegranteBD();
        await integranteBD.alterar(this);
    }

    async removerBancoDados(){
        const integranteBD = new IntegranteBD();
        await integranteBD.excluir(this);
    }
    ...
    async consultarCPF(cpf){
        const integranteBD = new IntegranteBD();
        const integrantes = await integranteBD.consultarCPF(termo);
        return integrantes;
    }
